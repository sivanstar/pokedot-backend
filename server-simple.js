...
userSchema.statics.updateUserRanks = async function() {
  try {
    ...
    console.log(`‚úÖ Updated ranks for ${users.length} users`);
  } catch (error) {
...
app.listen(PORT, () => {
  ...
  Ì≥ä Port: ${PORT}
  Ì≥¶ MongoDB: ${mongoose.connection.readyState === 1 ? 'Connected' : 'Disconnected'}
  ‚è∞ Time: ${new Date().toLocaleString()}
  `);
  console.log('\nÌ≥° Wallet Routes Mounted at /api/wallet:');
  console.log('   ‚úÖ PUT    /api/wallet/bank-details    - Update bank details');
  console.log('   ‚úÖ GET    /api/wallet/balance         - Get wallet balance');
  console.log('   ‚úÖ POST   /api/wallet/withdraw        - Request withdrawal');
  console.log('   ‚úÖ GET    /api/wallet/transactions    - Transaction history');
  console.log('   ‚úÖ GET    /api/wallet/withdrawals     - Withdrawal history');
  
  console.log('\nÌ≥° Admin Routes Mounted at /api/admin:');
  console.log('   ‚úÖ GET    /api/admin/stats            - System statistics');
  console.log('   ‚úÖ GET    /api/admin/users            - List users');
  console.log('   ‚úÖ GET    /api/admin/users/:userId    - Get user details');
  console.log('   ‚úÖ PUT    /api/admin/users/:userId    - Update user');
  console.log('   ‚úÖ PUT    /api/admin/users/:userId/password - Change password');
  console.log('   ‚úÖ DELETE /api/admin/users/:userId    - Delete/deactivate user');
  console.log('   ‚úÖ GET    /api/admin/users/:userId/wallet - Get user wallet');
  console.log('   ‚úÖ PUT    /api/admin/users/:userId/wallet - Update user wallet');
  console.log('   ‚úÖ GET    /api/admin/withdrawals      - List withdrawals');
  console.log('   ‚úÖ PUT    /api/admin/withdrawals/:withdrawalId - Update withdrawal');
  console.log('   ‚úÖ GET    /api/admin/pokes            - Poke history');
  console.log('   ‚úÖ GET    /api/admin/activities       - Recent activities');
  console.log('   ‚úÖ GET    /api/admin/task-stats       - Task completion stats');
  console.log('   ‚úÖ POST   /api/admin/create-admin     - Create admin user');
  
  console.log('\nÌ≥° Task Routes Mounted at /api/task:');
  console.log('   ‚úÖ GET    /api/task/status            - Check if task needed');
  console.log('   ‚úÖ POST   /api/task/complete          - Mark task completed');
});
